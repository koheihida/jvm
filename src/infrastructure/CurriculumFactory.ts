...
/**
 * JVMカリキュラムのファクトリー
 * セキュリティとデータ整合性を考慮したカリキュラム生成
 */
export class CurriculumFactory {
  /**
   * JVMカリキュラムを作成
   */
  static createJVMCurriculum(): CurriculumService {
    const modules = [
      CurriculumFactory.createJVMOverviewModule(),
      CurriculumFactory.createMemoryManagementModule(),
      CurriculumFactory.createClassLoadingModule(),
      CurriculumFactory.createPerformanceTuningModule()
    ];

    return new CurriculumService(modules);
  }

  private static createJVMOverviewModule(): Module {
    const topics = [
      Topic.create({
        id: 'what-is-jvm',
        title: 'JVMとは何か',
...
public class ArchitectureDemo {
  ...
  private static createMemoryManagementModule(): Module {
    const topics = [
      Topic.create({
        id: 'heap-memory',
        title: 'ヒープメモリ',
...
public class GCDemo {
  ...
  private static createClassLoadingModule(): Module {
    const topics = [
      Topic.create({
...
public class ClassLoaderDemo {
  ...
  private static createPerformanceTuningModule(): Module {
    const topics = [
      Topic.create({
        id: 'jvm-options',
        title: 'JVMオプション',
